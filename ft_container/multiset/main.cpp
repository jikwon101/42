...
void	print(X const& name, ft::multiset<T> const& src);
...
int main()
{
	...
	print("-------------------------\n");
	{
		...
		m1.insert(arr, arr+7);
		print("m1", m1);
		ft::multiset<int> m2(m1);
		ft::multiset<int> m3(m1.begin(), m1.begin());
		ft::multiset<int> m4(m1.begin(), m1.end());
		ft::multiset<int> m5;
		m5 = m1;
		print("m2", m2);
		print("m3", m3);
		...
		print("m5", m5);
		print("m5 reverse: ");
		for (ft::multiset<int>::reverse_iterator it = m5.rbegin() ; it != m5.rend() ; ++it)
		{
			print((*it)); print(" ");
		}
		NL;
		ft::multiset<int>::iterator it = m1.begin();
	...
	print("-------------------------\n");
	{
		ft::pair<ft::multiset<int>::iterator, ft::multiset<int>::iterator> res;
		ft::multiset<int> m1;
...
void	print(X const& name, ft::multiset<T> const& src)
{
	typename ft::multiset<T>::const_iterator it;
	int cnt = 0;
