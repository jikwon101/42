...
int main()
{
	...
	print("-------------------------\n");
	{
		...
		std::multiset<int> m3(m1.begin(), m1.begin());
		std::multiset<int> m4(m1.begin(), m1.end());
		std::multiset<int> m5;
		m5 = m1;
		print("m2", m2);
		print("m3", m3);
		...
		print("m5", m5);
		print("m5 reverse: ");
		for (std::multiset<int>::reverse_iterator it = m5.rbegin() ; it != m5.rend() ; ++it)
		{
			print((*it)); print(" ");
		}
		NL;
		std::multiset<int>::iterator it = m1.begin();
		std::multiset<int>::iterator cit(it);
		cit = it;
	...
	print("-------------------------\n");
	{
		...
		print("m1", m1);
		std::multiset<int> m3(arr, arr + 10);
		print("m3", m3);
	...
	print("-------------------------\n");
	{
		std::pair<std::multiset<int>::iterator, std::multiset<int>::iterator> res;
		std::multiset<int> m1;
