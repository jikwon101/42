#ifndef FT_SET_BASE_HPP
# define FT_SET_BASE_HPP
...
namespace ft
{
	...
	class set_base
	{
		protected:
			...
			typedef ft::node_set<value_type>	node;
			...
			size_type		_size;
			set_base(allocator_type const& alloc = allocator_type());
			~set_base();
			set_base(set_base const& src);
			set_base& operator=(set_base const& src);
