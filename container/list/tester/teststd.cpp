...
template <typename T>
void print_list(const std::list<T>& src);
...
int main()
{
	...
	}
	{
		...
		print_list(t2);
		std::list<int> t3(t2);				//copy
		print_list(t3);
		t1 = t3;							//operator=
		//t2 = t3;  // error : t2 const x
		print_list(t1);
		int arr[] = {1,2,3,4,5};
		std::list<int> t4(arr, arr +5);		///range
		print_list(t4);
	...
	{
		int arr[] = {1,2,3,4,5};
		std::list<int> t1(arr, arr +5);
		const std::list<int> t2(t1);
		std::list<int>::iterator it1 = t1.begin();
		print_it(it1);
		std::list<int>::const_iterator it2 = t1.end();
		std::list<int>::value_type value1 = t1.front();
		std::list<int>::value_type value2 = t1.back();
	...
	std::cout << "----------------------------\n";
	{
		...
		std::list<float> t1(arr, arr+6);
		print("t1:"); print_list(t1);
		print("t1: sort (comp)\n"); t1.sort(mycomparison);
		print("t1:"); print_list(t1);
		std::list<float> t2(arr, arr+6);
		print("t2:"); print_list(t2);
	...
	std::cout << "----------------------------\n";
	{
		...
		std::list<int> t1(arr1, arr1+5);
		std::list<int> t2(arr2, arr2+4);
		print("t1:"); print_list(t1);
		print("t2:"); print_list(t2);
	...
	std::cout << "----------------------------\n";
	{
		...
		std::list<float> t3(arr3, arr3 +3);
		std::list<float> t4(arr4, arr4 + 4);
