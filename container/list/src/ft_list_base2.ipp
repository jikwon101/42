...
template <typename T, typename Alloc>
typename list_base<T, Alloc>::size_type list_base<T, Alloc>::to_tail(node_pointer& nd)
{
	size_type cnt = 0;
...
template <typename T, typename Alloc>
void	list_base<T, Alloc>::insert_node_back(node_pointer& prev_node, node_pointer& new_node, size_type n)
{
...
template <typename T, typename Alloc>
void	list_base<T, Alloc>::insert_node_front(node_pointer& next_node, node_pointer& new_node, size_type n)
{
...
template <typename T, typename Alloc>
typename list_base<T, Alloc>::size_type	list_base<T, Alloc>::get_size() const
{
	return (_size);
}
...
void	list_base<T, Alloc>::swap_base(list_base& x)
{
	...
	head_node = x._head();
	x.insert_node_front(head_node, new_node_this, n_this);
}
